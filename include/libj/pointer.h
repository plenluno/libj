...
#define LIBJ_NULL_PTR(T, V) LIBJ_PTR(T) V(LIBJ_NULL(T), LIBJ_NULL_DELETER);
#define LIBJ_NULL_CPTR(T, V) LIBJ_CPTR(T) V(LIBJ_NULL(T), LIBJ_NULL_DELETER);
#define LIBJ_NULL_PTR_TYPE(T, V) typename LIBJ_NULL_PTR(T, V)
#define LIBJ_NULL_CPTR_TYPE(T, V) typename LIBJ_NULL_CPTR(T, V)
#define LIBJ_SINGLETON_PTR_TYPE(T, V, I) \
...
#define LIBJ_NULL_PTR(T, V) LIBJ_PTR(T) V(LIBJ_NULL(T));
#define LIBJ_NULL_CPTR(T, V) LIBJ_CPTR(T) V(LIBJ_NULL(T));
