...
#ifndef LIBJ_IMPL_FUNCTION_H_
#define LIBJ_IMPL_FUNCTION_H_

#define LIBJ_FUNCTION_INSTANCEOF(ID) \
    (ID == libj::Type<libj::Function>::id() || LIBJ_MUTABLE_INSTANCEOF(ID))
